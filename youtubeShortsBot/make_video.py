...
Tips and practical advice for everyday life
News and recent events around the world
Art and creativity, such as drawing, painting, or sculpting
Sports and fitness, with exercises or routines to try at home
Cuisine and international recipes
Music, with interesting facts about artists and musical genres
Philosophy and reflection on deep life topics."""

#prompt chatgpt (French)
#Write 50 short, intriguing facts about science and technology. Be careful to store them in a Python list.

import random

# ============================================
# Specify the content of your short vids
# ============================================
...
print('nb of phrases : ' + str(len(liste_phrases)))
...
def get_video_links():
    ...
    print("number of links found start : " + str(len(links)))
